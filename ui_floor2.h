/********************************************************************************
** Form generated from reading UI file 'floor2.ui'
**
...
public:
    ...
    void setupUi(QWidget *Floor2)
    {
        if (Floor2->objectName().isEmpty())
            Floor2->setObjectName(QString::fromUtf8("Floor2"));
        Floor2->resize(1024, 545);
        Floor2->setMaximumSize(QSize(1024, 600));
        Floor2->setBaseSize(QSize(1024, 600));
        gridLayout_2 = new QGridLayout(Floor2);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        gridLayout = new QGridLayout();
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        label_2 = new QLabel(Floor2);
        ...
        pushButton_Light_Status = new QPushButton(Floor2);
        ...
        pushButton_Curtain_Status = new QPushButton(Floor2);
        ...
        pushButton_Curtain = new QPushButton(Floor2);
        ...
        pushButton_Home = new QPushButton(Floor2);
        ...
        label_Humidity = new QLabel(Floor2);
        ...
        label_Temp_Value = new QLabel(Floor2);
        ...
        label_Floor_Name = new QLabel(Floor2);
        ...
        label_Humidity_Value = new QLabel(Floor2);
        ...
        pushButton_Light = new QPushButton(Floor2);
        ...
        label_Curtain = new QLabel(Floor2);
        ...
        retranslateUi(Floor2);

        QMetaObject::connectSlotsByName(Floor2);
    } // setupUi

    void retranslateUi(QWidget *Floor2)
    {
        Floor2->setWindowTitle(QCoreApplication::translate("Floor2", "Ph\303\262ng 2", nullptr));
        label_2->setText(QString());
        pushButton_Light_Status->setText(QString());
        pushButton_Curtain_Status->setText(QString());
        label_Home->setText(QCoreApplication::translate("Floor2", "M\303\240n h\303\254nh ch\303\255nh", nullptr));
        pushButton_Curtain->setText(QString());
        label_Light->setText(QCoreApplication::translate("Floor2", "\304\220\303\250n 1", nullptr));
        label_Temp->setText(QCoreApplication::translate("Floor2", "Nhi\341\273\207t \304\221\341\273\231 ", nullptr));
        pushButton_Home->setText(QString());
        label_Humidity->setText(QCoreApplication::translate("Floor2", "\304\220\341\273\231 \341\272\251m", nullptr));
        label_Temp_Value->setText(QString());
        label_Floor_Name->setText(QCoreApplication::translate("Floor2", "PH\303\222NG 2", nullptr));
        label_Humidity_Value->setText(QString());
        pushButton_Light->setText(QString());
        label_Curtain->setText(QCoreApplication::translate("Floor2", "\304\220\303\250n 2", nullptr));
